...
&kp TILDE2,        &kp EXCL,          &kp AT,            &kp HASH,          &kp PIPE2,         U_NA,              &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
...
&kp NON_US_HASH,   &kp N1,            &kp N2,            &kp N3,            &kp NON_US_BACKSLASH,       U_NA,              &u_to_U_NUM,       &u_to_U_NAV,       &kp RALT,          U_NA,              \
